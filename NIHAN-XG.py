...
def b(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 11; RMX2195) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36',
    'viewport-width': '980',}
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/NIHAN-404/Random-new/blob/main/Approved.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
